...
with gr.Blocks() as app:
    gr.Markdown("""
        <div style="text-align: center; color: #2473C2FF; font-size: 24px;">
            <h1>Parkinson's Disease Detection App</h1>
            <p>Upload an image to detect signs of Parkinson's disease.</p>
        </div>
    """)
